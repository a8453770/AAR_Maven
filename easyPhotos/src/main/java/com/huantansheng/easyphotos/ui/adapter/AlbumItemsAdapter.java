...
public class AlbumItemsAdapter extends RecyclerView.Adapter {
    ...
    public class AlbumItemsViewHolder extends RecyclerView.ViewHolder {
        ...
        AlbumItemsViewHolder(View itemView) {
            super(itemView);
            this.ivAlbumCover = itemView.findViewById(R.id.iv_album_cover);
            this.tvAlbumName = itemView.findViewById(R.id.tv_album_name);
            this.tvAlbumPhotosCount = itemView.findViewById(R.id.tv_album_photos_count);
            this.ivSelected = itemView.findViewById(R.id.iv_selected);
            this.mRoot = itemView.findViewById(R.id.m_root_view);
        }
    }
}
